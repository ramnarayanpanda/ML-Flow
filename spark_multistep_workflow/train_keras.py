...
def train_keras(ratings_data, als_model_uri, hidden_units):
    ...
    test_mse = random.randint(3, 9)
    train_mse = random.randint(12, 18)
    model = 'model'
    
    mlflow.log_metric("training_nrows", random.randint(1000,1005))
    mlflow.log_metric("test_nrows", random.randint(1000,1005))
